...
O watcher chama publisher(event). Este adaptador traduz cada chunk perdido em um comando REPLICATE_CHUNK publicado no tópico do nó-fonte (réplica viva) que executa a cópia via StoreChunk.
O nó-morto viaja no comando para o nó-fonte fechar o ciclo chamando UpdateChunkReplicas depois de copiar.
"""
...
class KafkaRereplicationPublisher:
    ...
    def __call__(self, event: dict) -> None:
        ...
        for lost in event.get("lost_chunks", []):
            ...
            # Publica no tópico do nó-fonte (ele lê local e copia para o destino).
