...
- **Metadados Persistentes com Rastreabilidade Multinível:** O estado lógico de todo o cluster é mantido de forma transacional e transparente por meio de um índice mestre baseado em JSON, mapeando com precisão as coordenadas físicas, lógicas e de tamanho e versão (timestamp) de cada arquivo, chunk e réplica.
