...
├── ARQUITETURA.md
└── (em Marco3/) run_cluster.py, run_cli.py
```
...
Compilar SEMPRE a partir da raiz do projeto (`DFS_M3/`), com `-I=.`, para os dois `.proto`:
...
Arquivos que importam `dfs` e rodam de dentro de `DFS_M3/` usam modo módulo
